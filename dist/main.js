...
*/ var r =
  ...
  function (e, t, n) {
      ...
      (null !== l
        ...
        r || null === l
          ? (function (e) {
              return (
                !!Q.call(H, e) ||
                (!Q.call(B, e) && (W.test(e) ? (H[e] = !0) : ((B[e] = !0), !1)))
              );
            })(t) &&
        ...
        extractEvents: function (e, t, n, r) {
          ...
          return (
            i
              ? (lr &&
                  ...
                  (sr || i !== ar.compositionStart
                    ...
                    : ((Qn = "value" in (Wn = r) ? Wn.value : Wn.textContent),
                      (sr = !0))),
            ...
            (e = rr
              ...
              ? (((t = Jn.getPooled(ar.beforeInput, t, n, r)).data = e), Vn(t))
              : (t = null),
    ...
    function hr(e, t, n) {
      return (
        ((e = qn.getPooled(mr.change, e, t, n)).type = "change"), M(n), Vn(e), e
      );
    }
    var vr = null,
      gr = null;
    ...
    function ql(e) {
      return null === Ul ? ((Ul = [e]), (jl = Cl(Ol, Xl))) : Ul.push(e), Dl;
    }
    function Yl() {
      if (null !== jl) {
        var e = jl;
          ...
          switch (i.$$typeof) {
            case ee:
              e: {
                ...
                i.type === ne
                  ? (((r = Du(i.props.children, e.mode, u, i.key)).return = e),
                    (e = r))
                  : (((u = Fu(
                      i.type,
                      i.key,
    ...
    function da(e, t, n) {
      return (
        (n = null != n ? n.concat([e]) : null), oa(4, 2, fa.bind(null, t, e), n)
      );
    }
    function pa() {}
    function ma(e, t) {
        ...
        if (
          ...
          try {
            var a = t.lastRenderedState,
              o = i(a, n);
            if (((l.eagerReducer = i), (l.eagerState = o), Vr(o, a))) return;
          } catch (e) {}
        nu(e, r);
      }
    }
              ...
              : ((n = null !== r),
                ...
                n &&
                  ...
                  0 != (1 & Ui.current)
                    ? Fo === Po && (Fo = No)
                    : ((Fo !== Po && Fo !== No) || (Fo = zo),
                      0 !== jo && null !== Mo && (Vu(Mo, Io), Wu(Mo, jo)))),
                (n || r) && (t.effectTag |= 4),
                null)
          );
        case 4:
    ...
    function ru(e, t) {
      ...
      return (
        null !== l && (Mo === l && (mu(t), Fo === zo && Vu(l, Io)), Wu(l, t)), l
      );
    }
    function lu(e) {
    ...
    function au(e, t) {
      ...
      if (0 !== n) {
        ...
        if ((Eu(), (e === Mo && n === Io) || su(e, n), null !== Ro)) {
          var r = Oo;
          Oo |= Co;
          for (var l = du(); ; )
            try {
          ...
          if ((ri(), (Oo = r), (To.current = l), 1 === Fo))
            throw ((t = Do), su(e, n), Vu(e, n), iu(e), t);
          if (null === Ro)
            switch (
    ...
    function ou(e) {
      ...
      if ((Eu(), (e === Mo && t === Io) || su(e, t), null !== Ro)) {
        var n = Oo;
        Oo |= Co;
        for (var r = du(); ; )
          try {
        ...
        if ((ri(), (Oo = n), (To.current = r), 1 === Fo))
          throw ((n = Do), su(e, t), Vu(e, t), iu(e), n);
        if (null !== Ro) throw Error(a(261));
    ...
    function su(e, t) {
      ...
      if ((-1 !== n && ((e.timeoutHandle = -1), Tn(n)), null !== Ro))
      ...
      for (;;) {
        try {
          ...
          if (
            ...
            (Ki = $i = Hi = null),
            (qi = !1),
            null === Ro || null === Ro.return)
          )
            return (Fo = 1), (Do = t), (Ro = null);
          e: {
            var l = e,
              i = Ro.return,
              a = Ro,
    ...
    function hu() {
      for (; null !== Ro; ) Ro = gu(Ro);
    }
    function vu() {
      for (; null !== Ro && !Ll(); ) Ro = gu(Ro);
    }
    function gu(e) {
    ...
    function yu(e) {
      ...
      do {
        var t = Ro.alternate;
        if (((e = Ro.return), 0 == (2048 & Ro.effectTag))) {
          if (((t = Ja(t, Ro, Io)), 1 === Io || 1 !== Ro.childExpirationTime)) {
            for (var n = 0, r = Ro.child; null !== r; ) {
              var l = r.expirationTime,
                i = r.childExpirationTime;
              l > n && (n = l), i > n && (n = i), (r = r.sibling);
            }
            Ro.childExpirationTime = n;
          }
          if (null !== t) return t;
          null !== e &&
            0 == (2048 & e.effectTag) &&
            (null === e.firstEffect && (e.firstEffect = Ro.firstEffect),
            null !== Ro.lastEffect &&
              (null !== e.lastEffect &&
                (e.lastEffect.nextEffect = Ro.firstEffect),
              (e.lastEffect = Ro.lastEffect)),
            1 < Ro.effectTag &&
              (null !== e.lastEffect
                ? (e.lastEffect.nextEffect = Ro)
                : (e.firstEffect = Ro),
              (e.lastEffect = Ro)));
        } else {
          if (null !== (t = eo(Ro))) return (t.effectTag &= 2047), t;
          null !== e &&
            ((e.firstEffect = e.lastEffect = null), (e.effectTag |= 2048));
        }
        if (null !== (t = Ro.sibling)) return t;
        Ro = e;
      } while (null !== Ro);
    ...
    function ku(e, t) {
            ...
            for (o = e, u = t; null !== Qo; ) {
              ...
              switch (1038 & w) {
                case 2:
                  ...
                  break;
                case 6:
                  po(Qo), (Qo.effectTag &= -3), go(Qo.alternate, Qo);
                  break;
                case 1024:
                  Qo.effectTag &= -1025;
                  break;
                case 1028:
                  (Qo.effectTag &= -1025), go(Qo.alternate, Qo);
                  break;
                case 4:
                  go(Qo.alternate, Qo);
                  break;
      ...
      if (
        ...
        1073741823 === t ? (e === Zo ? Go++ : ((Go = 0), (Zo = e))) : (Go = 0),
    ...
    function _u(e, t, n) {
      ...
      null !== r && r.delete(t),
        Mo === e && Io === n
          ? Fo === zo || (Fo === No && 1073741823 === Lo && Ql() - Wo < 500)
            ? su(e, Io)
            : (Vo = !0)
          : ju(e, n) &&
    ...
    xo = function (e, t, n) {
      ...
      if (null !== e) {
        ...
        if (e.memoizedProps !== l || vl.current) Ra = !0;
        else {
          if (r < n) {
            switch (((Ra = !1), t.tag)) {
              case 3:
      ...
      switch (((t.expirationTime = 0), t.tag)) {
        ...
        case 1:
          return (
            (r = t.type),
            (l = t.pendingProps),
            ja(e, t, r, (l = t.elementType === r ? l : Zl(r, l)), n)
          );
        case 3:
    ...
    function Fu(e, t, n, r, l, i) {
      ...
      if (((r = e), "function" == typeof e)) Ru(e) && (o = 1);
        ...
        e: switch (e) {
          ...
          case le:
            return (
              ((e = Mu(12, n, t, 8 | l)).elementType = le),
              (e.type = le),
              (e.expirationTime = i),
              e
            );
  ...
  function (e, t, n) {
    ...
    var r = n(0),
      l = n.n(r),
      i = n(2);
    const a = () => l.a.createElement("div", null, " app ");
    n.n(i).a.render(l.a.createElement(a, null), document.getElementById("app"));
  },
]);
